...
author: "Andreas Blinksbkerg-Kristensen"
...
Western_Europe %>% 
  ...
  geom_line()+
  theme_minimal()+
  labs(y= "Homicides per 100,000 people",
...
ggsave("homicedes5.png", width = 16, height = 8, dpi = 150)
...
kings <- read_csv2("data/danish_monarchs_full_estimates.csv", na = c("NULL","","NA"))
glimpse(kings)
...
ggplot(kings_clean, aes(x = midyear, y = duration)) +
  ...
  labs(
    ...
    caption = "Data source: danish_monarchs_full_estimates.csv") +
  theme_minimal()

ggsave("DanishMonarchs.png", width = 16, height = 8, dpi = 150)
